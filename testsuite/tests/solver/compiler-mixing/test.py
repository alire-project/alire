...
match_solution(f"gnat={version} (gnat_external) (shared)",
               escape=True)
...
match_solution("gnat_native=8888.0.0 (shared)", escape=True)
...
match_solution("gnat=" + e("8888.0.0 (gnat_native) (shared)") + ".*" +
               "gnat_native=" + e("8888.0.0 (shared)") + ".*")
...
match_solution("gnat_native=" + e("8888.0.0 (shared)") + ".*")
