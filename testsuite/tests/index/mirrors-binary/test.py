...
flat. `alr show` lists the mirrors after the origin.
"""
...
Origin: (case OS is others => binary archive crate-1.0.0.tgz at http://example.com/crate-1.0.0.tgz) with hash sha512:deadbeef
Mirrors:
   (case OS is others => binary archive crate-1.0.0.tgz at http://mirror1.example.com/crate-1.0.0.tgz)
