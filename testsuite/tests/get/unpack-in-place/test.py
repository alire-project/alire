...
compare(contents('libhello_1.0.0_filesystem'),
        ['libhello_1.0.0_filesystem/alire',
         ...
         'libhello_1.0.0_filesystem/alire/build_hash_inputs',
         'libhello_1.0.0_filesystem/alire/complete_copy',
         'libhello_1.0.0_filesystem/alire/config.toml',
         'libhello_1.0.0_filesystem/config',
         'libhello_1.0.0_filesystem/config/libhello_config.ads',
         'libhello_1.0.0_filesystem/config/libhello_config.gpr',
         'libhello_1.0.0_filesystem/config/libhello_config.h',
