...
package Alire.Lockfiles is
   ...
   --  A crate lockfile stores the dependency solution in use. This permanente
   --  storage, in <alire>/crate_name.lock, is the basis for ordely uploads and
   --  pinning. This file is autogenerated and manipulated via alr commands;
