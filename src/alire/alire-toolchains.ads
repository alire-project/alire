...
package Alire.Toolchains is
   ...
   Description : constant AAA.Strings.Vector
     ...
     .Append ("")
     .Append ("Use " & TTY.Terminal ("alr default-toolchain --help") &
                " to obtain information about toolchain management. Alire can "
              & "be configured to rely on a toolchain installed by the user "
              & "in the environment, or to use one of the indexed toolchains "
              & "whenever possible.")
     .Append ("")
