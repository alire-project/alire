      ...
      if not Initialized then
         ...
         Register
            ("crate_bin/alire.toml",
             ...
             GNAT.Calendar.Time_Of (2025, 06, 09, 14, 52, 10, 0.0));
         Register
            ("crate_bin/name.gpr",
         ...
         Register
            ("github/README.md",
             ...
             GNAT.Calendar.Time_Of (2025, 07, 03, 15, 30, 24, 0.0));
         Register
            ("github/publish.yml",
             r.github_publish_yml.Content'Access,
             GNAT.Calendar.Time_Of (2025, 07, 03, 18, 25, 39, 0.0));
         Register
            ("github/selftest.yml",
             r.github_selftest_yml.Content'Access,
             GNAT.Calendar.Time_Of (2025, 07, 03, 18, 27, 47, 0.0));
      end if;
   end Init;
