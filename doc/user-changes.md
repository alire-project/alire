...
### Crate descriptions are now included in generated configs

PR [#2028](https://github.com/alire-project/alire/pull/2028)
...
In `config/crate_config.ads`:
```ada
--  Configuration for crate generated by Alire
--  ...
package Crate_Config is
   Crate_Version        : constant String := "0.1.0-dev";
   Crate_Name           : constant String := "crate";
   Crate_Description    : constant String := "whimsical description"; --  New!
   --  ...
end Crate_Config;
```
